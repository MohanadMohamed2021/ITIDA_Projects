...
Q_CONSTINIT static const qt_meta_stringdata_CLASSTimerENDCLASS_t qt_meta_stringdata_CLASSTimerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(6, 7),  // "Display"
        QT_MOC_LITERAL(14, 0),  // ""
        QT_MOC_LITERAL(15, 6)   // "Buzzer"
    },
    "Timer",
    "Display",
    "",
...
void Timer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Timer::*)();
            if (_t _q_method = &Timer::Display; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Timer::*)();
            if (_t _q_method = &Timer::Buzzer; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
